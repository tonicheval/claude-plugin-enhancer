...
try {
    ...
    for (const target of targets) {
        ...
        else console.log(`      \x1b[31m✘ P2_fk (2.1.280 realpath helper): Not found - SESSION LIST WILL BE EMPTY on mapped drives\x1b[0m`);
        ...
        if (p8ctx) console.log(`      \x1b[36mℹ P8 bound to ExtensionContext '${p8ctx}'\x1b[0m`);
